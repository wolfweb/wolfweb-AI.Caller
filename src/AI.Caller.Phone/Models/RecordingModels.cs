...
public class RecordingResult {
    ...
    public static RecordingResult CreateSuccess(string callId, int recordingId, string message) => new() { Success = true, CallId = callId, RecordingId = recordingId, Message = message };
